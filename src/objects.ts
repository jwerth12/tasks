...
export function isCorrect(question: Question, answer: string): boolean {
    let inputted: string = answer.toLowerCase();
    inputted = inputted.trim();
    let correct: string = question.expected;
    correct = correct.toLowerCase();
    correct = correct.trim();
    return inputted === correct;
}
...
export function toMarkdown(question: Question): string {
    ...
    const listoptions: string = question.options.join("\n- ");
    return (
        "# " + question.name + "\n" + question.body + "\n" + "- " + listoptions
    );
}
...
export function addOption(question: Question, newOption: string): Question {
    const addedOptions = [...question.options, newOption];
    const newQuestion = { ...question, options: addedOptions };
    return newQuestion;
}
